...
from . import game, highscore, render
...
class App(oreoOS.App):
    ...
    def on_button_press(self, btn):
        ...
        # current direction.
        dx, dy = self._dir
        if btn == api.BTN_LEFT and dx == 0:
            self._next_dir = (-1, 0)
        elif btn == api.BTN_RIGHT and dx == 0:
            self._next_dir = (1, 0)
        elif btn == api.BTN_UP and dy == 0:
            self._next_dir = (0, -1)
        elif btn == api.BTN_DOWN and dy == 0:
            self._next_dir = (0, 1)
