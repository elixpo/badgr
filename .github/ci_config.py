...
# are more likely to warrant a README / HARDWARE / CONTRIBUTING update.
# For the badge, the OS layer + driver layer + the public app SDK are the
# things end-users and contributors actually read about.
CORE_PATHS = (
    "oreoOS/",
    "oreoWare/",
    "apps/",
